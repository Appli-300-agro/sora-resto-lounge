# sora.resto.lounge - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **sora.resto.lounge**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@sorarestolounge.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@sorarestolounge.cm` | `user123` | |
...
*   **Contact :** contact@sorarestolounge.cm